    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/other/${goodsDetail.categories?.[0].id}` }">{{
          ...
          <div class="goods-info" v-if="goodsDetail">
            <div class="media">
              ...
              <ul class="goods-sales">
                <li>
                  <p>销量人气</p>
                  <p> {{ goodsDetail.salesCount > 100 ? `${goodsDetail.salesCount} +` : goodsDetail.salesCount }}</p>
                  <p><i class="iconfont icon-task-filling"></i>销量人气</p>
                </li>
                <li>
                  <p>商品评价</p>
                  <p>{{ goodsDetail.commentCount > 100 ? `${goodsDetail.commentCount}+` : goodsDetail.commentCount }}
                  </p>
                  <p><i class="iconfont icon-comment-filling"></i>查看评价</p>
                </li>
                <li>
                  <p>收藏人气</p>
                  <p>{{ goodsDetail.collectCount > 100 ? `${goodsDetail.collectCount}+` : goodsDetail.collectCount }}
                  </p>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for=" (img, index) in goodsDetail.details?.pictures" :key="index" alt="" v-lazy-img="img">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
            <div class="goods-aside">
              <DetailHot :data="goodsDetail.hotByDay" title="每日热榜"></DetailHot>
              <DetailHot :data="goodsDetail.similarProducts" title="相关产品"></DetailHot>
            </div>
          </div>
        </div>
      </div>
