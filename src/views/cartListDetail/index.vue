...
<template>
    <div class="xtx-cart-page">
        <div class="container m-top-20">
            <div class="cart">
                <table>
                    <thead>
                        <tr>
                            <th width="120">
                                <el-checkbox @change="reChecked" :model-value="store.allCheck" />
                            </th>
                    ...
                    <tbody>
                        <tr v-for="i in store.carts" :key="i.skuId">
                            ...
                            <td>
                                <div class="goods">
                                    <!-- 此处需要skuid -->
                                    <RouterLink :to="`/detail/${i.skuId}`"><img :src="i.picture" alt="" /></RouterLink>
                                    <div>
            ...
            <div class="action">
                <div class="batch">
                    共 {{ store.allCount }} 件商品，已选择 {{ store.ischeckPrice.length }} 件，商品合计：
                    <span class="red">¥ {{ store.checkPrice }} </span>
                </div>
                <div class="total">
                    <el-button size="large" type="primary" @click="clickBuy">下单结算</el-button>
                </div>
            </div>
        </div>
    </div>
